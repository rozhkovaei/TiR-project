...
class BulletVirtualListControl : public VirtualListControl< BulletData >
{
public:
    BulletVirtualListControl( wxWindow *parent, const wxWindowID id, const wxPoint &pos, const wxSize &size )
        : VirtualListControl< BulletData >( parent, id, pos, size )
    {
        this->AppendColumn( "№" );
